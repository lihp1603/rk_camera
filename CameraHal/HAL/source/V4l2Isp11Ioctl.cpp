...
/* dpcc */
bool V4l2Isp11Ioctl::getDpccCfg(struct cifisp_dpcc_config &dpccCfg)
{
...
/* bls */
bool V4l2Isp11Ioctl::getBlsCfg(struct cifisp_bls_config &blsCfg)
{
...
/* degamma */
bool V4l2Isp11Ioctl::getSdgCfg(struct cifisp_sdg_config &sdgCfg)
{
...
/* lsc */
bool V4l2Isp11Ioctl::getLscCfg(struct cifisp_lsc_config &lscCfg)
{
...
/* awb measure */
bool V4l2Isp11Ioctl::getAwbMeasCfg(struct cifisp_awb_meas_config &awbCfg)
{
...
/* filter */
bool V4l2Isp11Ioctl::getFltCfg(struct cifisp_flt_config &fltCfg)
{
...
/* demosaic */
bool V4l2Isp11Ioctl::getBdmCfg(struct cifisp_bdm_config &bdmCfg)
{
...
/* cross talk */
bool V4l2Isp11Ioctl::getCtkCfg(struct cifisp_ctk_config &ctkCfg)
{
...
/* gamma out */
bool V4l2Isp11Ioctl::getGocCfg(struct cifisp_goc_config &gocCfg)
{
...
bool V4l2Isp11Ioctl::getHstCfg(struct cifisp_hst_config &hstCfg)
{
...
bool V4l2Isp11Ioctl::getAecCfg(struct cifisp_aec_config &aecCfg)
{
...
/* awb gain */
bool V4l2Isp11Ioctl::getAwbGainCfg(struct cifisp_awb_gain_config &awbgCfg)
{
...
/* color process */
bool V4l2Isp11Ioctl::getCprocCfg(struct cifisp_cproc_config &cprocCfg)
{
...
/* afc */
bool V4l2Isp11Ioctl::getAfcCfg(struct cifisp_afc_config &afcCfg)
{
...
/* ie */
bool V4l2Isp11Ioctl::getIeCfg(struct cifisp_ie_config &ieCfg)
{
...
/* dpf */
bool V4l2Isp11Ioctl::getDpfCfg(struct cifisp_dpf_config &dpfCfg)
{
...
bool V4l2Isp11Ioctl::getDpfStrengthCfg(struct cifisp_dpf_strength_config &dpfStrCfg)
{
...
bool V4l2Isp11Ioctl::getWdrCfg(struct cifisp_wdr_config &wdrCfg)
{
